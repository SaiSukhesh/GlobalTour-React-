...
export default function Places({ onBook, navigateTo }) {
          ...
          return (
            <div className="card" key={p.id}>
              <div className="card-img-wrap">
                <img className="pimg" src={p.img} alt={p.name} loading="lazy" style={{ cursor: 'pointer' }} onClick={() => navigateTo('/explore/detail', p.id)} />
              ...
              <div className="details">
                <h2 style={{ cursor: 'pointer' }} onClick={() => navigateTo('/explore/detail', p.id)}>{p.name}</h2>
